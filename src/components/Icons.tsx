...
export function ReloadIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function UploadIcon({ className, size = 48 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function DragIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function StatsIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function PathIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function LocateIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
