    ...
    const handleEditorWillMount: BeforeMount = (monaco: any) => {
      ...
      monaco.editor.defineTheme('yameilo-dark', {
        ...
        colors: {
          ...
          'editorWhitespace.foreground': '#cdd6f414',
          'editorIndentGuide.background': '#cdd6f40a',
          'editorIndentGuide.activeBackground': '#cdd6f41a',
          'editorError.foreground': '#f38ba8',
          'editorWarning.foreground': '#89dceb',
          'editorGutter.background': '#1e1e2e',
          'scrollbarSlider.background': '#cdd6f414',
          'scrollbarSlider.hoverBackground': '#cdd6f41a',
        },
      })
      ...
      monaco.editor.defineTheme('yameilo-light', {
        ...
        colors: {
          ...
          'editor.lineHighlightBackground': '#4c4f6908',
          'editorCursor.foreground': '#1e66f5',
          'editorWhitespace.foreground': '#4c4f6914',
          'editorIndentGuide.background': '#4c4f690a',
          'editorIndentGuide.activeBackground': '#4c4f691a',
          'editorError.foreground': '#d20f39',
          'editorWarning.foreground': '#04a5e5',
          'editorGutter.background': '#eff1f5',
          'scrollbarSlider.background': '#4c4f6914',
          'scrollbarSlider.hoverBackground': '#4c4f691a',
        },
      })
    }
